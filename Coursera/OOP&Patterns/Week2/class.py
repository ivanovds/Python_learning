...
It is a task from Coursera Python course: 
to create an abstract class for 3 classes: A, B, C 
wich have similar interfaces; and to create 
correct inheritance scheme.
